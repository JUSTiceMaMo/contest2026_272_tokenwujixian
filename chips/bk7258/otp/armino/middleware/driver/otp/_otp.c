...
const otp_item_t otp_map_2[9] = {
    {OTP_PHY_PWR,                 64,    0x0,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_RFCALI1,                256,    0x40,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_RFCALI2,                256,    0x140,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_RFCALI3,                256,    0x240,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_RFCALI4,                256,    0x340,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_MAC_ADDRESS1,             8,    0x440,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_MAC_ADDRESS2,             8,    0x448,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_MAC_ADDRESS3,             8,    0x450,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    {OTP_MAC_ADDRESS4,             8,    0x458,    OTP_READ_WRITE,    OTP_NON_SECURITY},
};
