/* NuttX-local replacement for Armino's bk_patch/wpa_err.h.  Keep the
 * vendor-visible error names, but do not depend on the optional Armino patch
 * directory being present in the source bundle. */
#pragma once
