 ...
 * at wifi/hal_port/vendor_sources/rw_msg_tx.c, which existed only to include this
...
int rw_msg_send_reset(void)
{
	 ...
	 * sides.  All probe logic lives in hal_port/scan_diagnostics.c; this file
...
int rw_msg_send_start(void)
{
	 ...
	 * hal_port/scan_diagnostics.c and bk7258_wifi_lower.c. */
