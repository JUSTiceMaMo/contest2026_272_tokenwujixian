 ...
 * at wifi/hal_port/vendor_sources/rw_msg_rx.c, which existed only to include this
...
uint32_t rwnx_get_wifi_rlk_start(void)
{
	 ...
	 * hal_port/include/components/log.h deliberately routes V to LOG_DEBUG instead,
